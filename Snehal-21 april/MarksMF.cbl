  1) total marks of male and female:
       ...
       77 WS-STAT   PIC 9(2).
       77 WS-MC     PIC 9(2) VALUE ZERO.
       77 WS-FC     PIC 9(2) VALUE ZERO.
       77 WS-MMARKS PIC 9(3) VALUE ZERO.
       77 WS-FMARKS PIC 9(3) VALUE ZERO.
       77 WS-MARK   PIC 9(3) VALUE ZERO.
       77 WS-SMARK  PIC 9(3) VALUE ZERO.
       PROCEDURE DIVISION.
       MAIN-PROCEDURE.
           OPEN INPUT STDFILE
           IF WS-STAT = '00' THEN
